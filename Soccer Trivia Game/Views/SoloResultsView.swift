...
/// Results screen for solo quiz game
struct SoloResultsView: View {
    ...
    /// Return all the way to the main home screen. Notifies parent to pop twice after we dismiss.
                    ...
                    VStack(spacing: 20) {
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 16)
                                ...
                                .shadow(color: RetroTheme.Colors.neonGreen.opacity(0.6), radius: 8, x: 0, y: 0)
                        )
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 16)
                                ...
                                .shadow(color: RetroTheme.Colors.neonBlue.opacity(0.6), radius: 8, x: 0, y: 0)
                        )
                        
                        // Average Time
                        HStack {
                            VStack(alignment: .leading, spacing: 8) {
                                Text("AVG TIME PER ANSWER")
                                    .retroText(style: RetroTheme.Typography.retroCaption(size: 14), color: RetroTheme.Colors.retroGray)
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 16)
                                .stroke(RetroTheme.Colors.neonYellow, lineWidth: 2)
                                .shadow(color: RetroTheme.Colors.neonYellow.opacity(0.6), radius: 8, x: 0, y: 0)
                        )
                    }
